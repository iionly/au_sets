...
function au_sets_init() {
	...
	elgg_register_plugin_hook_handler('prepare', 'notification:create:object:au_set', 'au_sets_notify_message');

	// determine urls
	elgg_register_plugin_hook_handler('entity:url', 'object', 'au_sets_url_handler');
 ...
 * @return boolean
 */
function au_sets_url_handler($hook, $type, $url, $params) {
