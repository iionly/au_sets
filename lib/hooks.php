 ...
 */
function au_sets_notify_message($hook, $type, $notification, $params) {
	...
	$notification->subject = elgg_echo('au_sets:notify:subject', array($entity->title), $language);
	$notification->body = elgg_echo('au_sets:notify:body', array(
		$owner->name,
		$entity->title,
		$entity->excerpt,
		$entity->getURL()
